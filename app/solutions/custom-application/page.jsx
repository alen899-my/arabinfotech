  ...
  return (
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <GradientButton 
                href="/contact"
                text="Lets Talk"
                icon={<LuArrowRight className="w-4 h-4 ml-2" />}
    ...
    <section className=" py-5 px-6 bg-white">
      ...
      <section className="py-5 px-6 bg-[#111] text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl  mt-5 mx-auto px-6 relative z-20 ">
             <CtaBanner/>
           </div>
    </div>
  );
...
function ServiceCard({ icon, title, desc, color, accent }) {
  return (
    ...
    >
      ...
      <p className="text-gray-400 roboto-texts leading-relaxed text-sm">
        {desc}
      </p>

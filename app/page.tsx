    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col justify-center translate-y-10 mt-25 px-6 transform translate-x-50 h-fit">
        ...
        <h1 className="momo-font  text-[clamp(28px,9vw,100px)] leading-none tracking-tight">
          Arab Web <br />Design Agency, <br />Delivering <br />Big Results
        </h1>
...
>
  ...
  Working Worldwide
         ...
         <div className="md:w-2/3  text-justify text-lg sm:text-xl md:text-2xl ">

  <p className="text-gray-100/80 font-light font-mono bg-black/10">
    We specialize in building standout websites and digital products that blend
    visual storytelling with clean development principles and strategic thinking.
  </p>

  <p className="text-gray-100/80 font-light font-mono bg-black/10">
    Clients describe us as lean, focused, and a refreshing alternative to larger 
    agencies. We bring big-team expertise with the care and precision of a 
    boutique studio.
  </p>
